...
openai.api_key = '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'
...
FALLAMOS
    ...
    palabras_en_negrita = ["PRIMERO.-", "SEGUNDO.-", "TERCERO.-", "CUARTO.-", "QUINTO.-", "SEXTO.-", "SÉPTIMO.-", "FALLAMOS", 'Cuestiones de orden público',  "Infracción de normas sustantivas y de la jurisprudencia" , "Costas, depósitos y consignaciones", "Revisión de hechos probados", "Infracción de normas procesales", "Inadmisibilidad del recurso", "Síntesis de la litis"]
    lineas_centrales = ["FALLAMOS"]

    # Aplicar estilo de negrita y centrado
    for palabra in palabras_en_negrita:
        start_index = '1.0'
        while True:
...
autos_year_options = ttk.Combobox(autos_frame, textvariable=autos_year_var, values=['2021', '2022', '2023'], width=5)
...
# Combobox a la derecha en la columna 2
recurso_year_options = ttk.Combobox(recurso_frame, textvariable=recurso_year_var, values=['2021', '2022', '2023'], width=5)
